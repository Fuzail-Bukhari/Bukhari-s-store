...
const products = [
  ...
  // WOMEN
  { name:"Khaadi Embroidered Lawn Kurta", price:3299, category:"Women", brand:"Khaadi", description:"Intricately embroidered lawn kurta. Timeless elegance.", image:"https://images.unsplash.com/photo-1583391733956-3750e0ff4e8b?w=400&h=300&fit=crop", countInStock:40 },
  ...
  { name:"Unze Embellished Wedding Heels", price:4999, category:"Women", brand:"Unze", description:"Handcrafted embellished heels. Perfect for weddings.", image:"https://images.unsplash.com/photo-1543163521-1bf539c55dd2?w=400&h=300&fit=crop", countInStock:20 },
  ...
  { name:"Women's Pearl Necklace Set", price:1999, category:"Women", brand:"Sapphire", description:"Elegant faux pearl necklace and earring set.", image:"https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?w=400&h=300&fit=crop", countInStock:45 },
  { name:"Women's Floral Perfume", price:4299, category:"Women", brand:"J. Junaid Jamshed", description:"Light floral fragrance. Feminine and long-lasting.", image:"https://images.unsplash.com/photo-1588776814546-1ffedbe74c80?w=400&h=300&fit=crop", countInStock:35 },
  ...
  { name:"Women's Wristlet Clutch", price:2499, category:"Women", brand:"Stylo", description:"Compact wristlet clutch with zip closure.", image:"https://images.unsplash.com/photo-1566150905458-1bf1fc113f0d?w=400&h=300&fit=crop", countInStock:30 },
  { name:"Bonanza Satrangi Shawl", price:3499, category:"Women", brand:"Bonanza", description:"Luxurious printed winter shawl. Warm and elegant.", image:"https://images.unsplash.com/photo-1601924994987-69e26d50dc26?w=400&h=300&fit=crop", countInStock:40 },

  // BOYS
  { name:"Boys Graphic Tee", price:999, category:"Boys", brand:"Outfitter", description:"Fun graphic printed tee. Soft cotton fabric.", image:"https://images.unsplash.com/photo-1622290291468-a28f7a7dc6a8?w=400&h=300&fit=crop", countInStock:60 },
  ...
  { name:"Boys School Backpack", price:1999, category:"Boys", brand:"Local Brand", description:"Spacious school backpack with multiple compartments.", image:"https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=400&h=300&fit=crop", countInStock:55 },
  { name:"Boys Eid Kurta Shalwar", price:2799, category:"Boys", brand:"Gul Ahmed", description:"Elegant embroidered kurta shalwar for Eid.", image:"https://images.unsplash.com/photo-1598300042247-d088f8ab3a91?w=400&h=300&fit=crop", countInStock:30 },
  ...
  { name:"Boys Formal Waistcoat Set", price:3499, category:"Boys", brand:"Sapphire", description:"Elegant 3-piece formal set for weddings.", image:"https://images.unsplash.com/photo-1507679799987-c73779587ccf?w=400&h=300&fit=crop", countInStock:20 },
  { name:"Boys Digital Watch", price:1299, category:"Boys", brand:"Local Brand", description:"Colorful digital watch with alarm and stopwatch.", image:"https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=400&h=300&fit=crop", countInStock:50 },

  // GIRLS
  { name:"Girls Floral Frock", price:1999, category:"Girls", brand:"Khaadi", description:"Beautiful floral printed frock in soft cotton.", image:"https://images.unsplash.com/photo-1518831959646-742c3a14ebf6?w=400&h=300&fit=crop", countInStock:45 },
  { name:"Girls Embroidered Frock", price:2799, category:"Girls", brand:"Sapphire", description:"Intricately embroidered frock for special occasions.", image:"https://images.unsplash.com/photo-1476234251651-f353703a034d?w=400&h=300&fit=crop", countInStock:30 },
  ...
  { name:"Girls Party Dress", price:3499, category:"Girls", brand:"Sapphire", description:"Gorgeous tulle party dress with satin bow.", image:"https://images.unsplash.com/photo-1476234251651-f353703a034d?w=400&h=300&fit=crop", countInStock:25 },
